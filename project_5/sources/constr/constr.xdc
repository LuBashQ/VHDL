...
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { channel_selector }]; #IO_L4N_T0_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { down }]; #IO_L9N_T1_DQS_AD3N_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { up }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
